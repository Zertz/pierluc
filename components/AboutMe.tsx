                ...
                <div className="relative lg:ml-10">
                  ...
                  <blockquote>
                    <div className="text-2xl leading-9 font-medium text-gray-900">
                      <p>
                        6+ years experienced, detail-oriented, self-taught full
                        stack JavaScript developer with a keen eye for UX design
                        and a knack for flame graphs. Presented talks on async
                        Javascript, GraphQL, and serverless architecture at a
                        local meetup. Attended Node+JS Interactive in 2015,
                        2017, and 2019.
                      </p>
                    </div>
